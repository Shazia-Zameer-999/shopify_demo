// "use client";  // ← This tells Next.js this component runs in the browser (not server)

// import { useState } from "react";  // ← Allows us to store data (like search input)
// import { useRouter } from "next/navigation";  // ← Allows us to navigate to other pages

// export default function SearchBar() {
//   // State to store what the user types
//   const [searchTerm, setSearchTerm] = useState("");
  
//   // State to store search results from Shopify
...
//   // This function runs when user types in the search box
//   async function handleSearch(e) {
//     const value = e.target.value;  // Get what user typed
//     setSearchTerm(value);  // Save it to state

//     // Only search if user typed 2 or more characters
//     if (value.length < 2) {
...
//     try {
//       // Call our API to search for products
...
//   // This function runs when user clicks on a product in dropdown
//   function handleSelectProduct(handle) {
//     router.push(`/products/${handle}`);  // Navigate to product page
//     setSearchTerm("");  // Clear search input
//     setResults([]);  // Clear results
//     setIsOpen(false);  // Close dropdown
//   }

//   // This function runs when user presses Enter or clicks search button
...
//           onFocus={() => searchTerm && setIsOpen(true)}  // Show dropdown when user focuses
...
//               className="w-full px-4 py-3 text-left hover:bg-gray-100 border-b last:border-b-0 transition flex items-center gap-3"
//             >
//               {/* Product Image */}
